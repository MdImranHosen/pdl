...
<?php
 ...
 if (isset($_GET['viewJobApplicatonCv']) && $_GET['viewJobApplicatonCv']) {
    $id = preg_replace('/\D/', '', $_GET['viewJobApplicatonCv']);
    $id = preg_replace('/[^-a-zA-Z0-9_]/', '', $_GET['viewJobApplicatonCv']);
...
<!--SideBar End-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        CV View
        <small><a href="#" onclick="history.go(-1);"><img src="upload/back.png" width="12px" height="12px"></a></small>
      </h1>
      <ol class="breadcrumb downdoad-font-size">
        <li><a href="downdoadcv.php?wordCvDownload=<?php echo $result['id']; ?>"><i class="fa fa-download"></i>WORD</a></li>
        <li><a href="downloadCvpdf.php?pdfCvDownload=<?php echo $result['id']; ?>"><i class="fa fa-download"></i>PDF</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title title-font-size">ব্যাক্তির নিজের সম্পর্কে</h3>
            </div>
            <!-- /.box-header -->
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title title-font-size">শিক্ষাগত যোগ্যতা</h3>
            </div>
            <div class="box-body">
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title title-font-size">পেশাগত অভিজ্ঞতা</h3>
            </div>
            <div class="box-body">
              <table>
                <tr>
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title title-font-size">বর্তমান ঠিকানা</h3>
            </div>
            <div class="box-body">
              <table>
                <tr>
                ...
                <?php if (!$result['house64'] == NULL || !$result['house64'] == 0 || !$result['house64'] == '') { ?>
                <tr>
                  <td>বর্তমান বাড়ি : </td>
                  <td><span class="fontsizecv"><?php
                   if ($result['house64'] == 1) {
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title title-font-size">স্থায়ী ঠিকানা</h3>
            </div>
            <div class="box-body">
              <table>
                <tr>
                ...
                <?php if (!$result['house65'] == NULL || !$result['house65'] == 0 || !$result['house65'] == '') { ?>
                <tr>
                  <td>স্থায়ী বাড়ি : </td>
                  <td><span class="fontsizecv"><?php
                   if ($result['house65'] == 1) {
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-body">
                <div class="form-group">
                 <label></label>
                 <span style="padding-left: 6px;"><img src="../<?php echo $result['image5']; ?>" width="150px" height="150px"/></span>
                </div>
            </div>
          </div>
          <!-- /.box -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title title-font-size">পরিবার সম্পর্কে </h3>
            </div>
              <div class="box-body">
                <table>
                  <tr>
                ...
                <?php  if (!$result['brother_h31'] == '' || !$result['brother_h31'] == 0) { ?>
                  <tr>
                    <td>ভাই কত জন: </td>
                    <td><span class="fontsizecv"> 
                      <?php  echo $result['brother_h31']; ?>
                    </span></td>
                  </tr>

                 <?php }  if (!$result['sister_h32'] == '' || !$result['sister_h32'] == 0) { ?>
                  <tr>
                    <td>বোন কত জন: </td>
                    <td><span class="fontsizecv">
                       <?php echo $result['sister_h32'];  ?>
                       </span></td>
                  </tr>
                  <?php } if (!$result['p_bro_sister33'] == '' || !$result['p_bro_sister33'] == 0) { ?>
                  <tr>
                    <td>ভাই বোনদের মধ্যে আপনার অবস্থান: </td>
                    <td><span class="fontsizecv">
                      <?php echo $result['p_bro_sister33']; ?>
                      </span></td>
                  </tr>
                  <?php } ?>
                </table>
              ...
              <div class="form-group">
                  ...
                  <p><span class="fontsizecv"> <?php
                        ...
                        echo $result['bro_sister_occ34'];
                        
                    ?></span></p>  
              </div>
               <?php } if (!$result['g_p_rab_army35'] == '') { ?>
              <div class="form-group">
                  ...
                  <p><span class="fontsizecv"> <?php echo $result['g_p_rab_army35']; ?></span></p> 
              </div>
               <?php } ?>
            </div>
              <!-- /.box-body -->
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title title-font-size">পরিদর্শন কৃত স্থান</h3>
            </div>
            <!-- /.box-body -->
           <div class="box-body">
               <div class="form-group">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title title-font-size">সাধারণ দক্ষতা</h3>
            </div>
            <!-- /.box-body -->
           <div class="box-body">
                <div class="row">
                  <div class="col-md-6 col-sm-6 col-xs-6">
                    <table>
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="fontsizecv"> <?php
                           if (!$result['report_writing38'] == 0) {
                            echo 'হাঁ';
                          }else{
                           echo 'না';
                           }
                    ...
                    ?></span>
                      ...
                      <tr>
                       ...
                       <td>
                         <span class="fontsizecv"> <?php
                          if (!$result['electrical_wiring40'] == 0) {
                            echo 'হাঁ';
                          }else{
                            echo 'না';
                          }
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title title-font-size">স্থানীয় অভিভাবক: </h3>
            </div>
            <!-- /.box-body -->
           <div class="box-body">
                  <table>
        ...
        <!--/.col (right) -->
        <div class="col-lg-12">
          <button type="button" onclick="history.go(-1);" class="btn btn-info pull-right">Back</button>
      </div>
