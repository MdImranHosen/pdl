...
<?php
 ...
 if (isset($_GET['pdfCvDownload']) && $_GET['pdfCvDownload']) {
    $id = preg_replace('/\D/', '', $_GET['pdfCvDownload']);
    $id = preg_replace('/[^-a-zA-Z0-9_]/', '', $_GET['pdfCvDownload']);
...
<div class="wrapper">
  ...
  <section class="content-header">
          ...
          <button onclick="myFunctionPdf()"><i class="fa fa-download">Download</i></button>
          <button onclick="history.go(-1);"><img src="upload/back.png" width="22px" height="22px"></button>
  </section>
    <!-- Main content -->
    <section class="content">
      <div class="row">
            ...
            <!-- /.box-header -->
              ...
              <div class="box-body">
                <table>
                  <tr align="right">
                    <td></td>
                    <td> <img src="../<?php echo $result['image5']; ?>" width="120px" height="120px"/></td>
                  </tr>
                  <tr>
                    <td>নাম : </td>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
           ...
           <div class="box-body">
             ...
             <?php if (!$result['driving44'] == 0) { ?>
              ...
              <div class="row">
                <div class="col-xs-12">
                  <label><u>কম্পিউটারের কোন কাজ গুলো জানেন তার নাম :</u></label>
          ...
          <!-- /.box -->
            <?php if (file_exists('../'.$result['image75'])) { ?>
            <div class="box box-warning">
            <div class="box-body">
              <div class="form-group">
                  <label>চারিত্রিক সনদপত্র :</label>
   ...
   <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Develop by </b> Tech Group
    </div>
    <strong>Copyright &copy; <?php echo date("Y"); ?> <a>WWW.PDL007.COM</a>.</strong> All rights
    reserved.
  </footer>
  <!-- /.content-wrapper -->
