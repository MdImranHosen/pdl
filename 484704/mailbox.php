          ...
          <div class="box box-primary">
            ...
            ?></h3>
              ...
              <div class="box-tools pull-right">
                <div class="has-feedback">
                  <input type="text" id="MailInput" class="form-control input-sm" placeholder="Search Mail">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-default btn-sm" id="delsel"><i class="fa fa-trash-o"></i></button>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody id="mailSearchTable"></tbody>
                </table>
                <!-- /.table -->
              </div>
              <!-- /.mail-box-messages -->
